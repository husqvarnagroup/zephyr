...
static uint8_t plaintext[64] __aligned(4) = {
...
void ecb_mode(const struct device *dev)
{
	...
	uint8_t ecb_plaintext[16] __aligned(4) = {
		0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
		0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF
	};
	uint8_t ecb_ciphertext[16] __aligned(4) = {
		0x69, 0xC4, 0xE0, 0xD8, 0x6A, 0x7B, 0x04, 0x30,
		0xD8, 0xCD, 0xB7, 0x80, 0x70, 0xB4, 0xC5, 0x5A
	};

	uint8_t encrypted[16] __aligned(4) = {0};
	uint8_t decrypted[16] __aligned(4) = {0};
...
{
	uint8_t encrypted[80] __aligned(4) = {0};
	uint8_t decrypted[64] __aligned(4) = {0};
	struct cipher_ctx ini = {
		.keylen = sizeof(key),
		.key.bit_stream = key,
		.flags = cap_flags,
...
{
	uint8_t encrypted[64] __aligned(4) = {0};
	uint8_t decrypted[64] __aligned(4) = {0};
	struct cipher_ctx ini = {
		.keylen = sizeof(key),
		.key.bit_stream = key,
...
static uint8_t ccm_data[23] __aligned(4) = {
